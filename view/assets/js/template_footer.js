...
<img class="logo_n" src="./assets/images/N_simple.png" width="24%" alt="NacionalMC">
<div class="container">
    <div class="row1">
        <section class="footer-section">
            <ul class="footer-links">
                ...
                <li><a href="./terms.php" data-traduccion="terminos_condiciones">TÉRMINOS Y
                        CONDICIONES</a></li>
            </ul>
        </section>
    </div>
...
<div class="container">
    ...
    <div class="row2">
        <section class="footer-bot">
            <p class="copyright-text" data-traduccion="derechos_reservados">Copyright © 2024 Todos los
